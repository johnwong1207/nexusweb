...
Words appear in a design for one reason: to make it easier to understand and use. They are design content, not decoration. Bring the same intentionality and minimalism to copywriting that you would bring to spacing and code quality. Before writing anything, ask what the design needs to say, and how it can best be said to help the person navigate the experience.
...
## NEXUS Learn application notes (project-specific)

Subject: AI education operating system + semiconductor STEM education. Audiences: principals, teachers, parents, students, investors.
Distinctive point of view for this build:
- Silicon-wafer vernacular: hairline circuit traces, etched panels, die grids, process-step numbering (01–07 is a genuine sequence).
- One memorable element per viewport: hero wafer core, then fab wafer. Everything else quiet.
- Monospace data labels allowed here (brief explicitly asks for MISSION-style UI) — keep them true data, not decoration.
- Brief wins over defaults: single-word headline highlight ("understands"), audience tabs, numbered fab steps.
